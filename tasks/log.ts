import { type CLICommandContext } from '@nitl-temp/tscli'
...
export default ({ label, message, timerStart, timerStop, ...args }: LogTaskFunctionArguments, { script }: CLICommandContext) => {
